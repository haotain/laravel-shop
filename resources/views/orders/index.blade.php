...
@section('content')
<div class="row">
<div class="col-lg-10 offsest-lg-1">
<div class="card">
                  ...
                  <tr>
                    <td class="product-info">
                      ...
                      <div >
                        ...
                        <span class="sku-tilte">{{ $item->productSku->title }}</span>
                      </div>
                    </td>
                    ...
                    @if($index === 0)
                      ...
                      <td rowspan="{{ count($order->items) }}" class="text-conter">
                        @if($order->paid_at)
                        ...
                        @else
                          未支付<br>
                          请于 {{ $order->created_at->addSeconds(config('app.order_ttl'))->format('H:i') }} 前完成支付<br>否则订单将自动关闭
                        @endif
                      </td>
