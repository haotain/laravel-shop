...
class Migrate extends Command
{
     ...
     * 创建索引
     */
    protected function createIndex($aliasName, $indexCalss)
    {
        // 调用 create() 方法创建索引
        $this->es->indices()->create([
            ...
            'index' => $aliasName . '_0',
            'body'  => [
                // 调用索引类的 getSettings() 方法获取索引字段
                'settings' => $indexCalss::getSettings(),
                'mappings' => [
                    // 调用索引类的 getProperties() 方法获取索引字段
                    'properties' => $indexCalss::getProperties()
                ],
                'aliases' => [
                    // 同时创建别名
     ...
     * 更新索引
     */
    protected function updateIndex($aliasName, $indexCalss)
    {
        // 暂时关闭索引
